...
export default function Register() {
  ...
  return (
    <div className='min-h-screen flex justify-center items-center bg-gray-100 dark:bg-gray-800 px-4'>
      <form className='w-full max-w-md bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-2xl p-6 sm:p-8 rounded-2xl'>
        ...
        <div className='flex flex-col gap-4 mt-4'>
          <ButtonComponent type='submit' text='Register' style={buttonStyle} />
